...
from .yolov8_iou_loss import YOLOv8IoULoss
from .iou_loss_diy import IoULoss1
__all__ = [
    ...
    'MarginL2Loss', 'MultiPosCrossEntropyLoss', 'L2Loss', 'TripletLoss','YOLOv8IoULoss','IoULoss1'
]
