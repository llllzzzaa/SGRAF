...
backend_args = None
load_from = '/root/autodl-tmp/UniRGB-IR1/weight/grounding_dino_swin-t_finetune_16xb2_1x_coco_20230921_152544-5f234b20.pth'  # noqa  
lang_model_name = '/root/autodl-tmp/UniRGB-IR1/bert-base-uncased'
class_name = ('person', 'car', 'bicycle')
metainfo = dict(classes=class_name, palette=[(220, 20, 60), (0, 255, 0), (0, 0, 255)]
                    )

model = dict(
    type='TextDualSpectralGroundingDINOillumV4_3',
    num_queries=900,
    ...
    data_preprocessor=dict(
        ...
        mean_ir=[136.63746562356317, 136.63746562356317, 136.63746562356317],
...
train_pipeline = [
    ...
    dict(
        ...
        meta_keys=('img_id', 'img_path', 'img_ir_path', 'ori_shape', 'img_shape',
                   ...
                   'custom_entities','scene')) #scene
]  

test_pipeline = [
    dict(type='LoadAlignedImagesFromFile', backend_args=backend_args),
    dict(type='AlignedImagesResize', scale=(640,640), keep_ratio=True),
    dict(type='LoadAnnotations', with_bbox=True),
    dict(
        type='PackAlignedImagesDetInputs',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        #ann_file='day_train.json',
        ann_file='annotation_train_scene.json',
...
val_evaluator = dict(
    ...
    ann_file=data_root + 'annotation_val_scene.json',
    metric='bbox',
    format_only=False,
    backend_args=backend_args)
